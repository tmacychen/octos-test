...
> **总计 277 个测试，通过 233，失败 19，跳过 25，通过率 84.1%**
...
| cli | 124 | 91 | 13 | 20 | 73.4% | ❌ 🟠 不足 |
| serve | 96 | 91 | 0 | 5 | 94.8% | ✅ 🟡 一般 |
| stdio | 6 | 1 | 5 | 0 | 16.7% | ❌ 🔴 严重不足 |
| **总计** | **277** | **233** | **19** | **25** | **84.1%** | **❌ 部分失败** |
...
**总计**: 124 | **通过**: 91 | **失败**: 13 | **跳过**: 20 | **通过率**: 73.4%
