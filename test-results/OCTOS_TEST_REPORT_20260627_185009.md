...
| 项目 | 值 |
|------|-----|
| **Octos 版本** | `octos 1.1.0 (c44a212c 2026-06-25)` |
| **测试日期** | 2026-06-27 17:33:51 |
| **报告生成** | 2026-06-27 18:50:09 |
...
> **总计 277 个测试，通过 237，失败 22，跳过 18，通过率 85.6%**

> **状态**: ❌ 部分失败


| 模块 | 总计 | 通过 | 失败 | 跳过 | 通过率 | 评估 |
|------|------|------|------|------|--------|------|
| bot | 51 | 50 | 1 | 0 | 98.0% | ❌ 🟢 良好 |
| cli | 124 | 95 | 16 | 13 | 76.6% | ❌ 🟠 不足 |
| serve | 96 | 91 | 0 | 5 | 94.8% | ✅ 🟡 一般 |
| stdio | 6 | 1 | 5 | 0 | 16.7% | ❌ 🔴 严重不足 |
| **总计** | **277** | **237** | **22** | **18** | **85.6%** | **❌ 部分失败** |

**失败模块**:

- **bot**: 1 个失败
  - `test_edit_preserves_message_identity`
- **cli**: 16 个失败
  - `provider minimax`
  - `data dir option`
  - `model claude`
...
**总计**: 51 | **通过**: 50 | **失败**: 1 | **跳过**: 0 | **通过率**: 98.0%
...
**总计**: 124 | **通过**: 95 | **失败**: 16 | **跳过**: 13 | **通过率**: 76.6%
...
| 2.24 | Chat | provider minimax | FAIL |
...
| 2.10 | Chat | data dir option | FAIL |
| 2.11 | Chat | streaming output | PASS |
| 2.12 | Chat | model claude | FAIL |
| 2.13 | Chat | model gpt4o | PASS |
| 2.14 | Chat | provider anthropic | FAIL |
| 2.15 | Chat | provider openai | FAIL |
| 2.16 | Chat | provider gemini | FAIL |
| 2.17 | Chat | provider deepseek | FAIL |
| 2.18 | Chat | provider ollama | FAIL |
| 2.19 | Chat | provider moonshot | FAIL |
| 2.20 | Chat | provider dashscope | FAIL |
| 2.21 | Chat | provider minimax | FAIL |
| 2.22 | Chat | provider groq | FAIL |
| 2.23 | Chat | custom base url | FAIL |
| 2.25 | Chat | deepseek full config | FAIL |
...
| 4.1 | Security | no api key error | PASS |
| 4.2 | Security | dangerous command rm rf | SKIP |
| 4.3 | Security | dangerous command sudo | SKIP |
| 4.4 | Security | fork bomb block | SKIP |
| 4.5 | Security | dd block | SKIP |
| 4.6 | Security | mkfs block | SKIP |
| 4.7 | Security | ssrf localhost | SKIP |
| 4.8 | Security | ssrf private ip | SKIP |
| 4.9 | Security | ssrf aws metadata | SKIP |
| 4.10 | Security | ssrf ipv6 loopback | SKIP |
| 4.11 | Security | ssrf ipv4 mapped | SKIP |
| 4.12 | Security | ssrf dns fail | PASS |
| 4.13 | Security | prompt injection | SKIP |
...
| 24.1 | Config | config priority | FAIL |
...
| 26.2 | Security | sandbox macos | SKIP |
| 26.3 | Security | sandbox linux | SKIP |
...
| 28.3 | ToolPolicy | provider policy | FAIL |
